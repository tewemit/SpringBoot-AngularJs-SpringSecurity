    ...
    describe('usersCtl', function () {
        ...
        beforeEach(inject(function (_$httpBackend_, $rootScope, $controller) {
            ...
            $httpBackend.expectGET('resources/i18n/en.json').
                respond({});
            $httpBackend.expectGET('/userById/?id=1').
                respond([{"id":1,"name":"test","email":"test@test.com","passowrd":"test","username":"test"}]);

            $scope = $rootScope.$new();
            $controller('userCtl', {$scope: $scope});
        }));
